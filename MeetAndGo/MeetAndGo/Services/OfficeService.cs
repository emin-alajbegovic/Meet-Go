...
namespace MeetAndGo.Services
{
    public class OfficeService : CRUDService<Model.Office, Database.Office, OfficeSearchObject, OfficeUpsertRequest, OfficeUpsertRequest>, IOfficeService
    {
        ...
        //    public List<Model.Office> Recommend(int officeId)
        //    {
        ...
        //            var tmpData = _dbContext.Office.Include("OfficeReview").ToList();
        //            var data = new List<ProductEntry>();

        //            foreach (var x in tmpData)
        //            {
        //                if (x.OfficeReview.Count > 1)
        //                {
        //                    var distinctItemId = x.OfficeReview.Select(y => y.OfficeId).ToList();
        //                    distinctItemId.ForEach(y =>
        //                    {
        //                        var relatedItems = x.OfficeReview.Where(z => z.OfficeId != y);
