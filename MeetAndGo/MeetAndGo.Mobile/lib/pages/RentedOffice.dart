...
class _RentedOfficeState extends State<RentedOffice> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<mdlRentedOffice>>(
        future: GetRentedOffices(),
        builder: (BuildContext context,
            AsyncSnapshot<List<mdlRentedOffice>> snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return ListView(
                children:
                    snapshot.data!.map((e) => RentedOfficeWidget(e)).toList());
          }
        },
      ),
    );
      ...
      child: TextButton(
        onPressed: () {
          Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      RentedOfficeDetails(product: rentedoffices)));
        },
        child: Column(
          children: [
            Padding(
