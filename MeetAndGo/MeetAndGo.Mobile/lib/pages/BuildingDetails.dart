...
import 'package:meet_go_mobile/pages/RentBuilding.dart';
...
class _BuildingDetailsState extends State<BuildingDetails> {
              ...
              RaisedButton(
                ...
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => RentBuilding(product: widget.product)));
                }
              ),
            ],
          ),
  ...
  Future<mdlTypeOfBuilding> fetchTypeOfBuilding() async {
    var typeOfBuilding = await APIService.GetById(
        'TypeOfBuilding', widget.product.typeOfBuildingId);
